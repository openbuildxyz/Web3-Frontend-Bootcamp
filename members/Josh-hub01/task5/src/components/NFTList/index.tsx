...
export default function NFTList() {
  ...
  if (result.data) {
    unlistings = result.data.transfers || [];
  }
  ...
  const handleConfirm = () => {
    const { tokenId } = selectedItem.current;
    ...
    writeContract({
      ...
      args: [nftContractAddress, tokenId, ethers.parseEther(field.value)],
    });
  };
