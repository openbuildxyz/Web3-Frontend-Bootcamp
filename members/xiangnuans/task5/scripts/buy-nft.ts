import { MarketAddress, MyTokenAddress } from "./config";
...
async function main() {
  ...
  // 获取支付代币的合约地址
  console.log("Payment Token Contract Address:", MyTokenAddress);
  const Token = await ethers.getContractAt("IERC20", MyTokenAddress);
