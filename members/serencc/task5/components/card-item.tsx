...
export const CardItem = ({
  ...
  const canDelist = isConnected && address === seller
  ...
  const handleDelist = () => {
    writeContractAsync({
      ...
      .then((res) => console.log("DelistNFT success", res))
      .catch((error) => console.log("DelistNFT failed", error))
  }
  ...
  return (
    <Card className="w-[350px]">
      ...
      <CardFooter className="flex justify-between space-x-4">
        ...
        <Button disabled={!canDelist} onClick={handleDelist} className="w-full">
          Delist
        </Button>
      </CardFooter>
    </Card>
